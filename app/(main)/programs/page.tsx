			...
			<div className="container mx-auto max-w-7xl px-4 animate-fadeIn">
				<div className="mx-auto max-w-3xl text-center">
					...
					<p className="mt-6 text-lg leading-8 text-muted-foreground">
						...
						fondo los programas presidenciales oficiales, sin acceso a noticias,
						redes sociales ni opiniones externas.
					</p>
					<p className="mt-4 text-lg leading-8 text-muted-foreground">
						...
						estructurado, capaz de comparar propuestas. Pero lo más importante:
						cada dato y conclusión se basa{' '}
				...
				<div className="mt-20">
					<div className="text-center">
						...
						<p className="mt-2 text-md text-muted-foreground">
							Estas son las fuentes públicas y oficiales que alimentan a nuestra
							IA.
						</p>
					</div>
