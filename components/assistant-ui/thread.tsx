...
const ThreadScrollToBottom: FC = () => {
	return (
		<ThreadPrimitive.ScrollToBottom asChild>
			<TooltipIconButton
				tooltip="Desplazarse hacia abajo"
				variant="outline"
			...
			<div className="mx-auto flex w-full max-w-[var(--thread-max-width)] flex-grow flex-col px-[var(--thread-padding-x)]">
				...
				<div className="flex w-full flex-grow flex-col items-center justify-center">
					...
					<div className="flex size-full flex-col justify-center px-8 md:mt-20">
						...
						>
							Análisis imparcial de los programas presidenciales 2025. Escribe
							tu consulta para comenzar.
						</motion.div>
					</div>
				</div>
			</div>
...
const ThreadWelcomeSuggestions: FC = () => {
	return (
		...
		<div className="grid w-full gap-2 sm:grid-cols-2">
			{[
				{
					title: '¿Cuáles son las propuestas',
					label: 'en salud de los candidatos?',
					action:
						'¿Cuáles son las propuestas en salud de los candidatos presidenciales?',
				},
				{
					title: 'Compara las propuestas',
					label: `económicas entre candidatos`,
					action: `Compara las propuestas económicas entre los diferentes candidatos presidenciales`,
				},
				{
					title: '¿Qué proponen para',
					label: `la educación en Chile?`,
					action: `¿Qué proponen los candidatos para mejorar la educación en Chile?`,
				},
				{
					title: 'Analiza las propuestas',
					label: 'de seguridad ciudadana',
					action:
						'Analiza las propuestas de seguridad ciudadana de los candidatos presidenciales',
				},
	...
	return (
		<MessagePrimitive.Root asChild>
			...
			>
				...
				<div className="ring-border/30 bg-background col-start-1 row-start-1 flex size-8 shrink-0 items-center justify-center rounded-full ring-1 relative overflow-hidden">
		...
		<div className="mx-auto flex w-full max-w-[var(--thread-max-width)] flex-col gap-4 px-[var(--thread-padding-x)]">
			...
			<ComposerPrimitive.Root className="bg-muted ml-auto flex w-full max-w-7/8 flex-col rounded-xl">
				...
				<div className="mx-3 mb-3 flex items-center justify-center gap-2 self-end">
					...
					<ComposerPrimitive.Send asChild>
						<Button size="sm" aria-label="Actualizar mensaje">
							Actualizar
						</Button>
					</ComposerPrimitive.Send>
				</div>
